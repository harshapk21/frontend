...
Array methods like map , filter etc do not work on them are they're still object but Array like :)
    Ex: arguments in functions, HTMLCollection but nodeList & arguments returned by methods of document object implements iterator & hence it can be used by for...of loop & can be spread as well.
...
// strings are both iterables & Array like i.e you can spread , use for...of and also access s[0],s[1],s.length but you cant modify them in-place like with array & also array mehtods won't be available to both of iterab & arraylike
log([...new Set([1, 2, 3])]);
log([..."hello"]);
...
// Array(1,2,3) is shorthand of new Array(1,2,3);
